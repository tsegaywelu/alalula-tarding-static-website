...
const News = () => {
    ...
    const videos=['./videos/news1.mp4','./videos/news2.mp4','./videos/news3.mkv','./videos/news4.mp4',
    './videos/news5.mp4','./videos/news6.mp4'
    ]
  ...
  return (
    ...
    <div className="flex justify-center text-2xl md:text-3xl font-bold mb-0">
        <i>ሓደሽቲ ሓበሬታት!</i>
    </div>

    <ul className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
    {videos.map((video, index) => (
  <li key={index} className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
    ...
    <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
      <h3 className="text-lg font-bold">this is the title of the videos ok listen me first to</h3>
      <p className="text-gray-600 two-lines">
        this is also the description of the video
      </p>
