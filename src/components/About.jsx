  ...
  return (
    <div>
      <section className=" flex gap-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="">
              ...
              <p className="mt-1  text-lg  text-black  ">
                ፈላማይ ኣፍሪካዊ ጀነራል ራእሲ ኣሉላ ኣባ ነጋ ኣብ ከባቢ ተምቤን መነወ ተባሂሉ ኣብ ዝፅዋዕ ቦታ
                ተወሊዱ ዝዓበየ ካብ <i className="text-blue-700">1827-1897 </i>ዓ/ም/ፈ
                ዝነበረ ስሙይ ኣዋጋኣይን ተዋግኣይን ጀነራል እዩ። <br />
                ራእሲ ኣሉላ ኣባ ነጋ ቅድሚ ዓወት ኲናት ዓድዋ ኣብ ኩፊት፣ ደጉዓሊ፣ሰሓጢት፣ ጉንደትን ጉራዕን ኣንፃር
                ባዕዳውያን ወረርቲ ገጢሙ ብዓወት ዝዛዘመ ስሙይ ጀነራል እዩ ነይሩ።ራስ ኣሉላ ኣብ ነጋ ፈታዊ ዓዱ፣
                ቆራፅ፣ ጅግና፣ በሊሕን መስተውዓልን ብዝኾነ ጥቕሚ ይኹን ምፍርራሕ ዓዱ ኣሕሊፉ ዘይህብ ኣብ ታሪኽ
                ትግራኛ ተዛረብቲ ህዝብን፣ ህዝብታት ኢትዮጵያን ናይ ባዕሉ ዓብዪ ታሪኻዊ ዓሻራ ዘዕረፈን ኢትዮጵያ
                ብባዕዳዊ ወረርቲ ከይተደፈረት ምስ ክብራ ክትቕፅል ዝገበረ ጅግና እዩ ነይሩ። <br />
                <br />
                ...
                <div>
                  <i className="text-blue-700 text-2xl block text-center">
                    ...
                    <FontAwesomeIcon icon={faUser} /> ኣባላት እዛ ማሕባር
                  </i>
                ...
                <br />
                እዞም ትግራይ ንኸይትውረር ክቡር መስዋእቲ ዝኸፈሉ፣ ናይ ኣካል መጉዳእቲ ዝበፅሖም ሓርበኛታት፣ ሕዚ
                እውን ምእንተ ትግራይ ኣብ ፈቐዶ በረኻ ዘለዉ ጀጋኑን ስድራ ጀጋኑን ብ ኢኮኖሚ ዓርሶም ክኽእሉ፣
        ...
        <div className=" lg:mt-11 h-full">
          <img src="./images/tdf3.PNG" alt="" />
        </div>
      </section>
    </div>
  );
