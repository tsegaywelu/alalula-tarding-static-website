      ...
      <div className="bg-gray-100">
        <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            ...
            <div className="flex gap-10">
              <div>
                ...
                <a className="my-3 block" href="/gallery">
                  gallery <span className="text-teal-600 text-xs p-1"></span>
                </a>
                <a className="my-3 block" href="/chat">
                  chat with us{" "}
          ...
          <div className="p-5 ">
            ...
            <a className="my-3 block" href="/#">
              +251-914730052 <span className="text-teal-600 text-xs p-1"></span>
            </a>
            <a className="my-3 block" href="/#">
              +251-921888602<span className="text-teal-600 text-xs p-1"></span>
            </a>
            <a className="my-3 block" href="/#">
              Email: alulamaekeledaga@gmail.com{" "}
              <span className="text-teal-600 text-xs p-1"></span>
            </a>
          </div>
